...
\begin{itemize}
    ...
    \item \textbf{Flask / SocketIO :} D\'eploiement de l'interface utilisateur (UI) permettant le chat en temps r\'eel et l'apparition dynamique des boutons de validation humaine.
\end{itemize}
...
\textbf{Fichier app.py} : Interface principale Flask
...
\begin{itemize}
    ...
    \item \textbf{Interface Web Fonctionnelle :} Application Flask avec chat temps r\'eel
